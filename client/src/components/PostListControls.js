...
export default function PostListControls({ setQueries, setRefresh }) {
  ...
  return (
    <form autoComplete="off">
      ...
      <button
        title="Refresh Posts!"
        className="w-full underline-none mt-2 p-2 border-2 text-gray-300 hover:text-blue-300 focus:text-blue-200 border-gray-200 hover:border-blue-200 focus:border-blue-200 rounded-2xl transition duration-200"
