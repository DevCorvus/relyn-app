  ...
  return (
    <div className="p-2 mb-2">
      ...
      <div
        ...
        className="p-2 text-center border-2 border-gray-200 rounded-md"
      >
        <div className="mx-auto bg-gray-200 rounded-full w-32 h-32 border border-black">
          {currentAvatar && (
            <img
              className="rounded-full"
              src={`https://avatars.dicebear.com/api/micah/${currentAvatar}.svg`}
              alt="Avatar"
            />
          )}
        </div>
        ...
        <div className="flex flex-col gap-2">
          <button
            className="w-full p-1 text-white bg-green-400 hover:bg-green-500 focus:bg-green-500 border-2 border-green-500 rounded-lg transition duration-200"
          ...
          <Link
            className="block w-full p-1 text-white bg-blue-400 hover:bg-blue-500 focus:bg-blue-500 border-2 border-blue-500 rounded-lg transition duration-200"
            to="/me/posts"
          >
            <div className="flex items-center justify-center gap-2">
      ...
      <Modal showModal={showEditProfile}>
        <div className="relative text-left bg-white p-4 rounded-md">
          <span className="text-xl font-semibold text-gray-300">Edit</span>
          <button
            onClick={() => setShowEditProfile(false)}
            title="Close"
            className="absolute top-1 right-1 bg-gray-100 bg-opacity-25 hover:bg-red-100 focus:bg-red-100 rounded-full p-1 text-gray-700 hover:text-red-400 focus:text-red-400 shadow-lg transition duration-200"
            type="button"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
