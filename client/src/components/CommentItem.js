...
export default function CommentItem({ comment: { _id, postId, username, body, edited, createdAt, updatedAt }, postUsername, setComments, setCommentsCount }) {
  ...
  return (
    <div className="border-2 border-gray-200 p-2 rounded-md shadow-sm">
      <div className="relative flex gap-2">
        <User username={username} size={10} avatar={userToShow.avatar} nickname={userToShow.nickname} />
