...
export default function AppLoading({ error = false }) {
  const backgroundStyle = { background: "linear-gradient(to right, #b06ab3, #4568dc)" };
  return (
        ...
        <div className="flex flex-col gap-4 items-center text-white">
          ...
          {error ? (
            <div className="text-center">
              <h2 className="text-red-50 text-xl font-semibold">The connection could not be established</h2>
