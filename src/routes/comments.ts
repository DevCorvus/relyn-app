...
router.post("/:postId/comments", [CsrfProtection, postValidationRules(), validate], [AuthToken], controller.store);
router.put("/:id/comments", [CsrfProtection, postValidationRules(), validate], [AuthToken], controller.update);
