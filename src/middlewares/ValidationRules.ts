...
export const userValidationRules = (req?: Request): any => {
  return [
    ...
    body(
      'username',
      'Username minimum length of 4 and maximum of 50 characters'
    )
      .trim()
      .escape()
      .blacklist(' ')
...
export const nicknameValidationRules = (req?: Request): any => {
  return [
    body('newNickname', 'Nickname required').not().isEmpty(),
...
export const loginValidationRules = (req?: Request): any => {
  return [
    body('usernameOrEmail', 'Username or Email required').not().isEmpty(),
    ...
    body(
      'password',
      'Password minimum length of 8 and maximum of 250 characters'
    )
      .trim()
      .isLength({ min: 8, max: 250 }),

    body('remember', 'Remember boolean required').isBoolean(),
  ];
};

export const postValidationRules = (req?: Request): any => {
  return [
    body('body', 'Body required').not().isEmpty(),
...
export const newEmailValidationRules = (req?: Request): any => {
  return [
    body('newEmail', 'New Email required').not().isEmpty(),
...
export const passwordChangeValidationRules = (req?: Request): any => {
  return [
    body('currentPassword', 'Current Password required').not().isEmpty(),
    body(
      'currentPassword',
      'Current Password minimum length of 8 and maximum of 250 characters'
    )
      .trim()
      .isLength({ min: 8, max: 250 }),
    ...
    body(
      'newPassword',
      'New Password minimum length of 8 and maximum of 250 characters'
    )
      .trim()
      .isLength({ min: 8, max: 250 }),
  ];
...
export const avatarValidationRules = (req?: Request): any => {
  return [
    body('newAvatar', 'New Avatar required').not().isEmpty(),
