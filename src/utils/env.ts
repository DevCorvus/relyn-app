...
export const SESSION_COOKIES_SECRET = process.env
  .SESSION_COOKIES_SECRET as string;
export const SIGNED_COOKIES_SECRET = process.env
  .SIGNED_COOKIES_SECRET as string;
